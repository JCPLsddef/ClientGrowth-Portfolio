...
export const en = {
  ...
  founder: {
    ...
    paragraphs: [
      "I run Client Growth myself, out of Laval, Quebec. When you hire me, you get me. Not a sales rep who vanishes after you sign. Not a junior learning on your account. Not a queue of other clients ahead of you.",
      "I take a maximum of three clients at a time. That is not a marketing line. It is how I make sure every system I build actually performs.",
      "I measure one number: qualified calls on your calendar. If that number is not growing, I have not done my job yet.",
    ],
...
export const fr: Dictionary = {
  ...
  founder: {
    ...
    name2: "Portillo-Laflamme",
    paragraphs: [
      "Je dirige Client Growth moi-même, depuis Laval, au Québec. Quand vous m'engagez, c'est moi que vous avez. Pas un vendeur qui disparaît après la signature. Pas un junior qui apprend sur votre compte. Pas une file d'autres clients devant vous.",
      "Je prends un maximum de trois clients à la fois. Ce n'est pas une phrase marketing. C'est comme ça que je m'assure que chaque système que je bâtis performe vraiment.",
      "Je mesure un seul chiffre : les appels qualifiés à votre calendrier. Si ce chiffre n'augmente pas, c'est que je n'ai pas encore fait mon travail.",
    ],
